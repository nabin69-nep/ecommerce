    ...
    <div className="grid container mx-auto px-3  grid-cols-[repeat(auto-fit,minmax(300px,11fr))] justify-center gap-x-2 gap-y-4 mt-12 items-center">
    {
      Products?Products.map((item,itemIndex)=>{
        ...
        <div className="flex mt-10 space-x-3">
          <Link href="/cart" onClick={()=>addToCartHandler(item)} className="px-4 py-2 bg-blue-500  text-white rounded-lg hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50">
